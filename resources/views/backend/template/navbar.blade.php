          ...
          <div class="flex items-center justify-between flex-grow px-4 mt-5 mb-11">
            <div class="flex items-center px-4 lg:hidden">
              <button @click.stop="sidebarToggle = !sidebarToggle"
                class="z-10 block bg-white p-1.5 rounded-lg lg:hidden shadow-sm hover:bg-gray-100 cursor-pointer">
              ...
              <div>
                <div class="m-1 z-40 hs-dropdown [--trigger:hover] relative
                  ...
                  <div aria-labelledby="hs-dropdown-hover-event-backend"
                    class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-56 bg-white shadow-md rounded-[18px] mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 border border-gray-300 before:absolute before:-top-4 before:start-0 before:w-full">
                    ...
                    @auth
                      <div class="space-y-0.5 mt-3 border-t-[1px] border-t-gray-200 mx-7 p-3 flex justify-center">
