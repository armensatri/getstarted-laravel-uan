<sidebar @click.outside="sidebarToggle = false"
  ...
  class="absolute top-0 left-0 z-50 flex flex-col w-64 h-screen overflow-y-hidden duration-300 ease-linear hover:overflow-y-scroll bg-white dark:bg-boxdark lg:static lg:translate-x-0 drop-shadow-md">
            ...
            @foreach ($menu->submenus as $submenu)
              <li class="px-2">
                <x-submenu
                  ...
                  :image="asset(\App\Enums\MenuIcon::get($submenu->name))"
                />
              </li>
            @endforeach
          @endforeach
